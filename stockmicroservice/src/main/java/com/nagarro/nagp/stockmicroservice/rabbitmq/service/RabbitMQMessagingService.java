package com.nagarro.nagp.stockmicroservice.rabbitmq.service;

import com.nagarro.nagp.stockmicroservice.rabbitmq.util.EventHandler;
import com.nagarro.nagp.stockmicroservice.rabbitmq.util.Events;
import com.nagarro.nagp.stockmicroservice.rabbitmq.util.Producer;
import com.nagarro.nagp.stockmicroservice.rabbitmq.util.QueueConsumer;
...
public class RabbitMQMessagingService {
    ...
    private void initialize() throws IOException, TimeoutException {
        ...
        //Initialize Producer
        producer = new Producer(publishingQueue, exchange, host);
    }
